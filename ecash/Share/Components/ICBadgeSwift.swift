...
//
import UIKit
@IBDesignable open class ICBadgeSwift: UILabel {
    ...
    private func setup() {
        ...
        self.font = AppFonts.moderateScale(fontName: AppFonts.SFranciscoRegular, size: AppFonts.FOOTER_LABEL_FONT_SIZE-4)
