    ...
    internal func div(_ a: ReductionPolynomial, _ b: ReductionPolynomial) -> (ReductionPolynomial, ReductionPolynomial) {
        ...
        while remainderDegree >= divisorDeg {
            ...
            if monomialExponent == 0 {
                ...
                // m = divisor * monomial remainder
                let m1 = monomialDivisor.0 * b.0
                let m2 = monomialDivisor.0 * b.1 + monomialDivisor.1 * b.0
                let m3 = monomialDivisor.0 * b.2 + monomialDivisor.1 * b.1 + monomialDivisor.2 * b.0
                let mtemp = monomialDivisor.0 * b.3 + monomialDivisor.1 * b.2 + monomialDivisor.2 * b.1
                let m4 = mtemp + monomialDivisor.3 * b.0
